...
class ValidSequence_3_3 {
    public static void main(String[] args) {
        ValidSequence_3_3 obj = new ValidSequence_3_3();
        System.out.println(Arrays.toString(obj.validSequence("kkkjkkjkkjjkjjkkjj", "jj")));
    }
    ...
    public int[] validSequence(String s1, String s2) {
        ...
        result.sort((a, b) -> a.stream()
                               .map(String::valueOf)
                               .collect(Collectors.joining(""))
                               .compareTo(b.stream().map(String::valueOf).collect(Collectors.joining(""))));
