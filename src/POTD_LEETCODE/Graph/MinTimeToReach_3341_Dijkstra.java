...
class MinTimeToReach_3341_Dijkstra {
    public static int minTimeToReach(int[][] moveTime) {
        ...
        while (!pq.isEmpty()) {
            ...
            // now let's calculate when we will be leaving this node
            if (r != 0 && c != 0) t = Math.max(t, moveTime[r][c]); // NO NEED TO CHECK THIS AS THIS MAX WAS ALREADY CHECKED WHILE PUTTING IN QUEUE
