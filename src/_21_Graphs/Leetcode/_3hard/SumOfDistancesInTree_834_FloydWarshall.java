...
class SumOfDistancesInTree_834_FloydWarshall {
    ...
    public int[] sumOfDistancesInTree(int n, int[][] edges) {
        /*
         * Steps: here as we need to calculate distance of each pair to another pair while the getValue of each edge is
         * same which we can assume 1 hence we will be applying Floyd Warshall Algorithm
         * Floyd Warshall : make a 2D array where :
         * 1. First put given edges u->v getValue as 1, put i == j cases getValue a 0 & rest getValue as infinity
         * 2. Now in Floyd Warshall what we do is we make each index of gird {i,j} traverse through each node
         * 3. And we try to get the minimum getValue we can get & store it
         * */
