...
// here we made lca value can max hit k hence lca's axes got optimized
// TLE : 675 / 676 testcases passed
class SubtreeInversionSum_3544_4Memoization {
    public long subtreeInversionSum(int[][] edges, int[] nums, int k) {
        ...
        Long[][][] dp = new Long[nv + 1][k + 1][2];                     // IT MAKES THE TIME-COMPLEXITY N^2 ATLEAST, NEED TO DO SOMETHING HERE
    ...
    public static void main(String[] args) {
        ...
        int k = 2;
        var obj = new SubtreeInversionSum_3544_4Memoization();
