...
//  2- coded after reading some observation from others code & editorial
// our second visited array got visited recently
class SecondMinimum_2045_Editorial_2 {
    public static int secondMinimum(int n, int[][] edges, int time, int change) {
        ...
        while (!q.isEmpty()) {
            ...
            if (second[n] != Integer.MAX_VALUE) {
                return second[n]; // our second visited array got visited recently
            }
